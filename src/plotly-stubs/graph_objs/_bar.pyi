...
class Bar(_BaseTraceType):
    ...
    @property
    def base(self) -> Any | None: ...
    @base.setter
    def base(self, val: Any | None) -> None: ...
    @property
    def basesrc(self) -> str | None: ...
    @basesrc.setter
    def basesrc(self, val: str | None) -> None: ...
    @property
    def cliponaxis(self) -> bool | None: ...
    @cliponaxis.setter
    def cliponaxis(self, val: bool | None) -> None: ...
    @property
    def constraintext(self) -> str | None: ...
    ...
    @property
    def insidetextanchor(self) -> str | None: ...
    @insidetextanchor.setter
    def insidetextanchor(self, val: str | None) -> None: ...
    @property
    def insidetextfont(self) -> Insidetextfont: ...
    ...
    @property
    def offset(self) -> int | float | Sequence[int] | Sequence[float]: ...
    @offset.setter
    def offset(
    ...
    @property
    def offsetsrc(self) -> str | None: ...
    @offsetsrc.setter
    def offsetsrc(self, val: str | None) -> None: ...
    @property
    ...
    @property
    def outsidetextfont(self) -> Outsidetextfont: ...
    ...
    @property
    def textposition(self) -> str | Sequence[str]: ...
    @textposition.setter
    ...
    @property
    def width(self) -> int | float | Sequence[int] | Sequence[float]: ...
    @width.setter
    def width(
        self, val: int | float | Sequence[int] | Sequence[float] | np.ndarray[tuple[int, ...], np.dtype[np.float64]]
    ) -> None: ...
    @property
    def widthsrc(self) -> str | None: ...
    @widthsrc.setter
    def widthsrc(self, val: str | None) -> None: ...
    @property
    def x(
        self,
    ) -> ArrayLike: ...
